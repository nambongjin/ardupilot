#include "QGCMissionDoMountControl.h"
#include "ui_QGCMissionDoMountControl.h"
#include "WaypointEditableView.h"

QGCMissionDoMountControl::QGCMissionDoMountControl(WaypointEditableView* WEV) :
    QWidget(WEV),
    ui(new Ui::QGCMissionDoMountControl)
{
    ui->setupUi(this);
    this->WEV = WEV;
...
QGCMissionDoMountControl::~QGCMissionDoMountControl()
{
    delete ui;
}
