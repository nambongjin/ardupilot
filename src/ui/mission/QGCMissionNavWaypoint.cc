...
QGCMissionNavWaypoint::QGCMissionNavWaypoint(WaypointEditableView* WEV) :
    QWidget(WEV),
    ui(new Ui::QGCMissionNavWaypoint)
    {
        ui->setupUi(this);
        this->WEV = WEV;
...
void QGCMissionNavWaypoint::updateFrame(MAV_FRAME frame)
{
    switch(frame)
    {
...
QGCMissionNavWaypoint::~QGCMissionNavWaypoint()
{
    delete ui;
}
