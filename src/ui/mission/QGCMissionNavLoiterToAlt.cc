#include "QGCMissionNavLoiterToAlt.h"
#include "ui_QGCMissionNavLoiterToAlt.h"
#include "WaypointEditableView.h"

QGCMissionNavLoiterToAlt::QGCMissionNavLoiterToAlt(WaypointEditableView* WEV) :
    QWidget(WEV),
    ui(new Ui::QGCMissionNavLoiterToAlt)
    {
    ui->setupUi(this);
    this->WEV = WEV;
...
void QGCMissionNavLoiterToAlt::updateFrame(MAV_FRAME frame)
{
    switch(frame)
    {
...
QGCMissionNavLoiterToAlt::~QGCMissionNavLoiterToAlt()
{
    delete ui;
}
